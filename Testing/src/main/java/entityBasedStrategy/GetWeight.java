...
public class GetWeight implements UDF4 <WrappedArray<Long>, WrappedArray<Long>, WrappedArray<Long>, Long, Double> {
	
	private static Logger log = LoggerFactory.getLogger(GetWeight.class);
