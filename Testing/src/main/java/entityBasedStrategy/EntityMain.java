...
public class EntityMain {
	...
	public static void main(String[] args) {
		...
		dfWNP = dfWNP.withColumn("AverageWeight", expr("Weight / NumberOfEdges")).drop("CoOccurrenceBag").drop("Frequencies").drop("SetOfNeighbors").drop("NumberOfBlocks").drop("Weight");
		dfWNP.show(false);
		dfWNP.printSchema();
...
class getFrequencies implements UDF2 <WrappedArray<Long>, Integer, List<Integer>> {
