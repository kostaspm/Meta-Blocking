...
public class EdgeBasedCNP {
	...
	public static void main(String[] args) {
		...
		Dataset<Row> dfnodesCNP = dfnodes
		...
		dfnodesCNP = dfnodesCNP.withColumn("AllTogether", explode(dfnodesCNP.col("AllTogether")));
		
		// Extracts the 1st node from every pair. We have the (i, j.Wij) (j, i.Wij) in a single column
		dfnodesCNP = dfnodesCNP.withColumn("Node", dfnodesCNP.col("AllTogether").getItem("col1"))
							   .withColumn("Node2_Weight", dfnodesCNP.col("AllTogether").getItem("col2")).drop("AllTogether");
