...
public class EdgeBasedCNP {
	...
	public static void main(String[] args) {
		...
		Dataset<Row> dfnodesCNP = cnpPruning(dfnodes);
		System.out.println(
				"====================================================CNP RESULT====================================================");
	...
	private static Dataset<Row> cnpPruning(Dataset<Row> df) {
		...
		// df.show(false);
		df = df.withColumn("Node2_Weight_Filtered", slice(df.col("Node2_Weight"), 1, 1)).drop("Node2_Weight"); // second
																												// argument
																												// is
																												// the
																												// N
